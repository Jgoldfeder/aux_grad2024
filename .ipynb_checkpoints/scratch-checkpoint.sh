...
CUDA_VISIBLE_DEVICES=5,6 bash distributed_train.sh 2 --data-dir /data/torch/cifar100  --dataset torch/cifar100 -b=64 --img-size=224 --epochs=90 --color-jitter=0 --amp --lr=0.001 --sched='step' --model-ema --model-ema-decay=0.995 --reprob=0.5 --smoothing=0.1 --train-interpolation=bilinear --aa=v0 --model=resnet101  --num-classes=100 --opt=adam --weight-decay=1e-4 --log-wandb --dataset-download --experiment "cifar100"  --name  "resnet101 Pretrain adam 90 epochs metabalance_ fc1 1 .1"  --decay-rate 0.1 --decay-epochs 30 --metabalance --pretrained  --weights 1 .1 &

CUDA_VISIBLE_DEVICES=2,3 MASTER_PORT=44145 bash distributed_train.sh 2 --data-dir /data/torch/cifar10  --dataset torch/cifar10 -b=128 --img-size=224 --epochs=90 --color-jitter=0 --amp --lr=0.001 --sched='step' --model-ema --model-ema-decay=0.995 --reprob=0.5 --smoothing=0.1 --train-interpolation=bilinear --aa=v0 --model=resnet101  --num-classes=10 --opt=adam --weight-decay=1e-4 --log-wandb --dataset-download --experiment "cifar10"  --name  "resnet101 Pretrain adam 90 epochs base fc1 "  --decay-rate 0.1 --decay-epochs 30  --pretrained  &



CUDA_VISIBLE_DEVICES=4 python train.py --data-dir /data/torch/cifar10  --dataset torch/cifar10 -b=128 --img-size=224 --epochs=90 --color-jitter=0 --amp --lr=0.001 --sched='step' --model-ema --model-ema-decay=0.995 --reprob=0.5 --smoothing=0.1 --train-interpolation=bilinear --aa=v0 --model=resnet50  --num-classes=10 --opt=adam --weight-decay=1e-4 --log-wandb --dataset-download --experiment "cifar10"  --name  "SCRATCH adam 90 epochs metabalance_ fc1 full logging"  --decay-rate 0.1 --decay-epochs 30 --metabalance  &

CUDA_VISIBLE_DEVICES=5 python train.py --data-dir /data/torch/cifar10  --dataset torch/cifar10 -b=128 --img-size=224 --epochs=90 --color-jitter=0 --amp --lr=0.001 --sched='step' --model-ema --model-ema-decay=0.995 --reprob=0.5 --smoothing=0.1 --train-interpolation=bilinear --aa=v0 --model=resnet50  --num-classes=10 --opt=adam --weight-decay=1e-4 --log-wandb --dataset-download --experiment "cifar10"  --name  "Pretrain adam 90 epochs metabalance_ fc1 full logging"  --decay-rate 0.1 --decay-epochs 30 --metabalance --pretrained  &


CUDA_VISIBLE_DEVICES=3 python train.py --data-dir /data/torch/cifar10  --dataset torch/cifar10 -b=128 --img-size=224 --epochs=90 --color-jitter=0 --amp --lr=0.001 --sched='step' --model-ema --model-ema-decay=0.995 --reprob=0.5 --smoothing=0.1 --train-interpolation=bilinear --aa=v0 --model=resnet50  --num-classes=10 --opt=adam --weight-decay=1e-4 --log-wandb --dataset-download --experiment "cifar10"  --name  "SCRATCH adam 90 epochs base fc1"  --decay-rate 0.1 --decay-epochs 30   &




CUDA_VISIBLE_DEVICES=0 python train.py --data-dir /data/torch/stl10  --dataset torch/stl10 -b=128 --img-size=224 --epochs=90 --color-jitter=0 --amp --lr=0.001 --sched='step' --model-ema --model-ema-decay=0.995 --reprob=0.5 --smoothing=0.1 --train-interpolation=bilinear --aa=v0 --model=resnet50  --num-classes=102 --opt=adam --weight-decay=1e-4 --log-wandb --dataset-download --experiment "stl10"  --name  "Pretrain adam 90 epochs metabalance_ fc1 .1 1"  --decay-rate 0.1 --decay-epochs 30 --metabalance --pretrained  --weights .1 1 &
...
CUDA_VISIBLE_DEVICES=3,4,5 bash distributed_train.sh 3  --data-dir /data/torch/aircraft  --dataset torch/aircraft -b=43 --img-size=224 --epochs=90 --color-jitter=0 --amp --lr=0.001 --sched='step' --model-ema --model-ema-decay=0.995 --reprob=0.5 --smoothing=0.1 --train-interpolation=bilinear --aa=v0 --model=resnet50  --num-classes=211 --opt=adam --weight-decay=1e-4 --log-wandb --dataset-download --experiment "aircraft"  --name  "SCRATCH adam 90 epochs metabalance_ fc1 first order_0.01_ clip both"  --decay-rate 0.1 --decay-epochs 30 --metabalance &
...
CUDA_VISIBLE_DEVICES=3 python train.py   --data-dir /data/torch/aircraft  --dataset torch/aircraft -b=43 --img-size=224 --epochs=90 --color-jitter=0 --amp --lr=0.001 --sched='step' --model-ema --model-ema-decay=0.995 --reprob=0.5 --smoothing=0.1 --train-interpolation=bilinear --aa=v0 --model=resnet50  --num-classes=211 --opt=adam --weight-decay=1e-4 --log-wandb --dataset-download --experiment "aircraft"  --name  "SCRATCH adam 90 epochs metabalance_ fc1 test__"  --decay-rate 0.1 --decay-epochs 30 --metabalance &
...
CUDA_VISIBLE_DEVICES=1 python train.py --data-dir /data/torch/pets  --dataset torch/pets -b=128 --img-size=224 --epochs=90 --color-jitter=0 --amp --lr=0.1 --sched='step' --model-ema --model-ema-decay=0.995 --reprob=0.5 --smoothing=0.1 --train-interpolation=bilinear --aa=v0 --model=resnet50  --num-classes=37 --opt=SGD --weight-decay=1e-4 --log-wandb --dataset-download --experiment "pets"  --name  "simple Pretrain SGD 90 epochs metabalance_ fc1"  --decay-rate 0.1 --decay-epochs 30 --metabalance --pretrained --simpleloader &

CUDA_VISIBLE_DEVICES=2 python train.py --data-dir /data/torch/pets  --dataset torch/pets -b=128 --img-size=224 --epochs=90 --color-jitter=0 --amp --lr=0.1 --sched='step' --model-ema --model-ema-decay=0.995 --reprob=0.5 --smoothing=0.1 --train-interpolation=bilinear --aa=v0 --model=resnet50  --num-classes=37 --opt=SGD --weight-decay=1e-4 --log-wandb --dataset-download --experiment "pets"  --name  "simple Pretrain SGD 90 epochs base fc1 "  --decay-rate 0.1 --decay-epochs 30  --pretrained --simpleloader &



CUDA_VISIBLE_DEVICES=4 python train.py --data-dir /data/torch/pets  --dataset torch/pets -b=128 --img-size=224 --epochs=90 --color-jitter=0 --amp --lr=0.1 --sched='step' --model-ema --model-ema-decay=0.995 --reprob=0.5 --smoothing=0.1 --train-interpolation=bilinear --aa=v0 --model=resnet50  --num-classes=37 --opt=SGD --weight-decay=1e-4 --log-wandb --dataset-download --experiment "pets"  --name  "simple SCRATCH SGD 90 epochs metabalance_ fc1"  --decay-rate 0.1 --decay-epochs 30 --metabalance --simpleloader &

CUDA_VISIBLE_DEVICES=3 python train.py --data-dir /data/torch/pets  --dataset torch/pets -b=128 --img-size=224 --epochs=90 --color-jitter=0 --amp --lr=0.1 --sched='step' --model-ema --model-ema-decay=0.995 --reprob=0.5 --smoothing=0.1 --train-interpolation=bilinear --aa=v0 --model=resnet50  --num-classes=37 --opt=SGD --weight-decay=1e-4 --log-wandb --dataset-download --experiment "pets"  --name  "simple SCRATCH SGD 90 epochs base fc1"  --decay-rate 0.1 --decay-epochs 30 --simpleloader  &
